  ...
  <page title="活动详情"
    ...
    <div class="activity-details-info">
      <div>
        ...
        <div class="flex mt8"
             v-if="activityDetailData.activityAttachmentList.length > 0">
          <div class="w98 mt16">图片:</div>
          <div class="flex w855">
            <div v-for="(item,index) in activityDetailData.activityAttachmentList"
                 :key="index"
                 class="relative mt16">
              <img :src="$fileHost + item.url"
                   alt=""
                   class="landmark-img "
                   @click="lookBigPhoto(activityDetailData.activityAttachmentList,index)" />
            </div>
          </div>
        </div>
        <div class="flex mt24">
        ...
        <div class="mt24 flex"
          ...
          <div>
            ...
            <div class="flex flex-wrap">
              <div v-for="(item,index) in activityDetailData.styleAttachmentList"
                   :key="index">
                <img :src="$fileHost + item.url"
                     alt=""
