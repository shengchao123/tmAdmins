...
export default {
  ...
  methods: {
    // 查询
    onNew () {
      this.$router.push({ name: 'CommunityAddPost' })
    },
    // 查询
    onInquire () {
    ...
    // 详情按钮
    onDetail (id) {
      this.$router.push({ name: 'CommunityPostDetail', query: { id: id } })
    },
    // 查看热度明细
    onHeat (row) {
...
const noteManage = Object.freeze([// 帖子管理
  {
    label: '帖子ID',
    prop: 'code',
    width: 140
